...
hoursGrid.innerHTML = "<span>Dimanche :</span> <span>11h - 22h</span><span>Lundi :</span> <span>11h - 15h</span><span> Mardi :</span > <span>11h - 15h</span> <span>Mercredi :</span> <span>11h - 22h</span> <span>Jeudi :</span> <span>11h - 22h</span> <span>Vendredi :</span> <span>11h - 23h</span> <span>Samedi :</span> <span>11h - 23h</span>";
contentHours.appendChild(hoursGrid);

// Contenu pour l'adresse 
...
valuesPara.innerHTML = "Formosa Bites</strong>, nous mettons un point d’honneur à utiliser des <strong>ingrédients <br>frais et authentiques</strong>. Nos plats sont préparés selon des recettes <br> traditionnelles taïwanaises, pour vous offrir un goût inoubliable."
contentValues.appendChild(valuesPara);

// Contenu pour les avis des clients
...
testimonialsPara.innerHTML = '<blockquote>Le Bubble Tea est excellent et les perles ont la texture parfaite.”</blockquote> <br> <blockquote>“Les meilleurs Gua Bao que j’ai mangés en dehors de Taïwan ! Un pur délice.”</blockquote> <br> <blockquote>“Ambiance chaleureuse et plats incroyables. J’y retournerai sans hésiter !”</blockquote>';
